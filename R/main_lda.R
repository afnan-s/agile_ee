...
# results <- validate(data = data, type = "test", lda_model = lda_model, FE = "LDA")
...
for(project_name in projects) {
    ...
    #Find statistics per cluster:
    result <- validate(data = data, project_name = project_name, FE = "LDA", type = "test", lda_model = lda_model)
